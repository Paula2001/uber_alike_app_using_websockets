...
class ChatHandler{
    private $tree_locations ;
    public function __construct()
    {
        $this->tree_locations = new BinaryTree();
    }
    ...
    public function createChatBoxMessage($chat_user,$chat_box_message) {
        if($chat_user === 'driver'){
            $this->tree_locations->insert($chat_box_message,$chat_user);
        }
        $messageArray = array("$chat_user"=>$this->tree_locations);
