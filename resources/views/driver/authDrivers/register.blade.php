                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('driver.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="vehicle_type" type="text" class="form-control @error('vehicle_type') is-invalid @enderror" name="vehicle_type" value="{{ old('vehicle_type') }}" required autocomplete="vehicle_type">
